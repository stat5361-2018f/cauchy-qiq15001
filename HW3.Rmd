...
{x^2}{(1+x^2)^3}dx=\frac{2}{\pi}[\int_R\frac{2}{(1+x^2)^3}dx-\int_R\frac{1}{(1+x^2)^2}dx]$$

Let $K_n=\int_R\frac{1}{(1+x^2)^n}dx$, then $$K_n=\int_R\frac{1+x^2}{(1+x^2)^{n+1}}dx=\int_R\frac{1+x^2}{(1+x^2)^{n+1}}dx=K_{n+1}+$$
